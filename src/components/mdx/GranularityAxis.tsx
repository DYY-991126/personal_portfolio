  ...
  return (
    ...
    >
      ...
      <div className="relative h-56 mb-2">
        ...
        <div
          className="absolute right-[8%] top-[48%] -translate-y-1/2 w-28 h-28 min-w-28 rounded-full flex items-center justify-center text-sm font-medium bg-[#F5F5DC] text-[#1A1A1A] border border-[#F5F5DC] shrink-0"
        >
          <span className="whitespace-nowrap">我们的设计</span>
        </div>
      </div>
